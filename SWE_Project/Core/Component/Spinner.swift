...
//  VNOMU
//
//  Created by Khalid R on 24/02/1446 AH.
//
import SwiftUI
    ...
    var body: some View {
        ZStack {
            ...
            ZStack {
                ...
                // S3
                SpinnerCircle(start: spinnerStart, end: spinnerEndS2S3, rotation: rotationDegreeS3, color: color2, lineWidth: lineWidth)
// S2
                SpinnerCircle(start: spinnerStart, end: spinnerEndS2S3, rotation: rotationDegreeS2, color: color2, lineWidth: lineWidth)
                
       

                // S1
                SpinnerCircle(start: spinnerStart, end: spinnerEndS2S3, rotation: rotationDegreeS1, color: color1, lineWidth: lineWidth)
